      ...
      <header className={`masthead ${this.props.hero && this.props.hero.image ? 'masthead--has-shadow' : ''}`}>
            ...
            <section className='navigation-wrapper'>
              <nav className='navbar' role='navigation' aria-label='main navigation'>
                <div className='navbar-brand'>
                  ...
                  <ViewportMobile>
                    <Button name='Menu open' aria-hidden='false' className={`navbar-burger burger ${this.state.mobileMenuOpen ? 'is-active' : ''}`} aria-controls='nav-primary' aria-haspopup={!this.state.mobileMenuOpen} aria-expanded={this.state.mobileMenuOpen} aria-label={this.state.mobileMenuOpen ? 'Hide navigation' : 'Show navigation'} clickHandler={this.handleMenuClick.bind(this)} data-target='nav-primary'>
                      <span aria-hidden='true'></span>
                      <span aria-hidden='true'></span>
                      <span aria-hidden='true'></span>
                    </Button>

                    {this.props.hasSearch && <Button name='Submit search' className='btn--flat is-hidden-tablet offset-top' clickHandler={this.handleSearchClick.bind(this)}><Icon {...iconWhite}/></Button>}
                  </ViewportMobile>                
                </div>
                ...
                {this.props.hasSearch && <div className='navbar-end is-hidden-mobile'>
                  <Button className='btn--flat' clickHandler={this.handleSearchClick.bind(this)} name='Submit search'><Icon {...iconWhite}/></Button>
                </div>}        
              </nav>
            </section>
          </div>
        ...
        {(this.state.takeover && this.props.hasSearch) && <section className='masthead__takeover'>
          <div className='masthead__takeover__inner'>
            <Button className='close' clickHandler={this.handleSearchClick.bind(this)} name='Close takeover'><Icon {...iconClose}/></Button>
